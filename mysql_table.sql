...
CREATE  TABLE IF NOT EXISTS `menu` (
  ...
  `anchor_title` VARCHAR(128) NULL DEFAULT NULL COMMENT 'anchor long title of a menu item' ,
  ...
  `query` VARCHAR(256) NULL DEFAULT NULL COMMENT 'menu item query' ,
  `class` VARCHAR(56) NULL DEFAULT NULL COMMENT 'menu item class' ,
